...
CREATE TABLE `TP_DSW_BDD`.`Solicitud`(
    ...
    insert into TP_DSW_BDD.Cliente VALUES (1, 'Juan', 'Gonzalez', 'DSADAS', '1234', '123456789', 'juangonzalez');
    insert into TP_DSW_BDD.Cliente VALUES (2, 'Pedro', 'Lopez', 'DSaaaDAS', '1234', '123456789', 'pedrolopez');
